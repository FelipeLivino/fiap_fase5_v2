...
def features(row):
    ...
    # Booleanos, valores ausentes e números não finitos não representam medições válidas.
...
def train(rows):
    ...
    # A versão reúne dados e parâmetros para rastrear qual treinamento gerou cada avaliação.
